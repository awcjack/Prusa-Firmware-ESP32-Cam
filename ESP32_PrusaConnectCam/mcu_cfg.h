...
/* Prusa Link local API — printer IP and X-Api-Key */
#define EEPROM_ADDR_PRUSALINK_IP_START            (EEPROM_ADDR_EXT_SENS_UNIT_START + EEPROM_ADDR_EXT_SENS_UNIT_LENGTH)
#define EEPROM_ADDR_PRUSALINK_IP_LENGTH           16  ///< 1 byte length + 15 bytes IPv4 string

#define EEPROM_ADDR_PRUSALINK_APIKEY_START        (EEPROM_ADDR_PRUSALINK_IP_START + EEPROM_ADDR_PRUSALINK_IP_LENGTH)
#define EEPROM_ADDR_PRUSALINK_APIKEY_LENGTH       17  ///< 1 byte length + 16 bytes API key string

/* Factory defaults */
#define FACTORY_CFG_PRUSALINK_IP                  F("")   ///< empty = disabled
#define FACTORY_CFG_PRUSALINK_APIKEY              F("")
...
#define EEPROM_SIZE (EEPROM_ADDR_REFRESH_INTERVAL_LENGTH + EEPROM_ADDR_FINGERPRINT_LENGTH + EEPROM_ADDR_TOKEN_LENGTH + \
                     ...
                     EEPROM_ADDR_EXT_SENS_ENABLE_LENGTH + EEPROM_ADDR_EXT_SENS_UNIT_LENGTH + \
                     EEPROM_ADDR_PRUSALINK_IP_LENGTH + EEPROM_ADDR_PRUSALINK_APIKEY_LENGTH)
